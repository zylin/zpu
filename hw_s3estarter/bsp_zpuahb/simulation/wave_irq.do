...
add wave -noupdate -radix hexadecimal -expand -subitemconfig {/top_tb/top_i0/box_i0/gpioo.dout {-height 15 -radix hexadecimal} /top_tb/top_i0/box_i0/gpioo.oen {-height 15 -radix hexadecimal} /top_tb/top_i0/box_i0/gpioo.val {-height 15 -radix hexadecimal} /top_tb/top_i0/box_i0/gpioo.sig_out {-height 15 -radix hexadecimal}} /top_tb/top_i0/box_i0/gpioo
add wave -noupdate -divider {IRQ stuff}
add wave -noupdate -radix hexadecimal /top_tb/top_i0/box_i0/apbo(8).pirq
add wave -noupdate -radix hexadecimal /top_tb/top_i0/box_i0/ahbso(0).hirq
add wave -noupdate -expand /top_tb/top_i0/box_i0/apbctrl_i0_apbi
add wave -noupdate -radix hexadecimal /top_tb/top_i0/box_i0/apbctrl_i0/ahbo.hirq
add wave -noupdate -radix hexadecimal /top_tb/top_i0/box_i0/apbctrl_i0/apbi.pirq
add wave -noupdate -radix hexadecimal /top_tb/top_i0/box_i0/ahbctrl_i0_msti.hirq
add wave -noupdate -radix hexadecimal -expand -subitemconfig {/top_tb/top_i0/box_i0/irqmp_i0_irqo(0) {-height 15 -radix hexadecimal -expand} /top_tb/top_i0/box_i0/irqmp_i0_irqo(0).irl {-height 15 -radix hexadecimal} /top_tb/top_i0/box_i0/irqmp_i0_irqo(0).rst {-height 15 -radix hexadecimal} /top_tb/top_i0/box_i0/irqmp_i0_irqo(0).run {-height 15 -radix hexadecimal} /top_tb/top_i0/box_i0/irqmp_i0_irqo(0).rstvec {-height 15 -radix hexadecimal}} /top_tb/top_i0/box_i0/irqmp_i0_irqo
add wave -noupdate -divider LEDs
add wave -noupdate -radix hexadecimal -expand -subitemconfig {/top_tb/tb_led(7) {-height 15 -radix hexadecimal} /top_tb/tb_led(6) {-height 15 -radix hexadecimal} /top_tb/tb_led(5) {-height 15 -radix hexadecimal} /top_tb/tb_led(4) {-height 15 -radix hexadecimal} /top_tb/tb_led(3) {-height 15 -radix hexadecimal} /top_tb/tb_led(2) {-height 15 -radix hexadecimal} /top_tb/tb_led(1) {-height 15 -radix hexadecimal} /top_tb/tb_led(0) {-height 15 -radix hexadecimal}} /top_tb/tb_led
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {785889695 ps} 0} {{Cursor 2} {600030000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1543556831 ps}
